...
class MagicPlayer:
    ...
    def flame(self, player, cost, groups):
        if player.energy >= cost:
            ...
            if player.status.split("_")[0] == "right": direction = pg.math.Vector2(1,0)
            elif player.status.split("_")[0] == "left": direction = pg.math.Vector2(-1,0)
            elif player.status.split("_")[0] == "up": direction = pg.math.Vector2(0,-1)
